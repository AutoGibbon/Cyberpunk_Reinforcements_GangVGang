...
public class GR_es_mx extends ModLocalizationPackage{
	...
	protected func DefineTexts(){
        ...
        this.Text("GibbonGR-CallSuccessCooldownMin-Name", "Tiempo de espera mínimo para llamada");
        ...
        this.Text("GibbonGR-CallSuccessCooldownMax-Name", "Tiempo de espera máximo para llamada");
        ...
        this.Text("GibbonGR-HeatResetCooldown-Name", "Tiempo de espera límite");
        this.Text("GibbonGR-HeatResetCooldown-Description", "Cuánto tiempo debe esperar una pandilla antes de pedir de nuevo después de alcanzar el límite de llamadas");
        ...
        this.Text("GibbonGR-CallsLimit-Description", "El número de llamadas que una pandilla puede hacer antes de tener que esperar el tiempo de espera límite");
        ...
        this.Text("GibbonGR-Cooldowns-Category", "Tiempos de espera");
